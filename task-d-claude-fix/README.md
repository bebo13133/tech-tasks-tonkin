...
без финансов/правен/медицински съвет) + контекста на потребителя — същият
base prompt, който заданието дефинира в Задача B.

**Защо го смених и аз:** генеричният промпт не носи нито тона, нито
ограниченията на продукта, така че реално отслабва поведението на ментора.
Възможно е дори това да е умишлено заложена слабост в задачата (наред с трите
технически бъга), затова възстановяването на коректния МАБИ промпт смятам за
част от поправката.

> ⚠️ **Бележка за работна среда:** в реален проект промяна на system prompt-а
> на продуктов компонент **не се прави самоволно** — минава през съгласуване с
> ръководителя на задачата/проекта (продуктов tone, правни ограничения и
> бранд звучене са негова отговорност). Тук съзнателно избрах пълния МАБИ
> промпт само защото заданието изрично го предоставя като base prompt; при
> реална работа бих го потвърдил преди да го пусна.
